...
class AnnotatorInterface:
    ...
    def person_identification_routine(self):
        ...
        while not self.object_detector_kill_trigger:
            ...
            curr_persons = [curr_persons[pid] for pid in range(len(curr_persons)) if
                            curr_persons[pid]['id'] not in pid_to_remove]
        ...
        if len(self.persons) > 0:
            ...
            with self.persons_lock:
                ...
                for curr_person in curr_persons.values():
                    ...
                    is_same_person = curr_person['id'] in self.persons and self.persons[curr_person['id']]['hash'] == \
                                     curr_person['hash']
                    ...
                    if is_same_person and self.persons[curr_person['id']]['pose_2d'] is not None:
                        ...
                        smoothed_joints_3d = 0.85 * curr_person['pose_3d'].get_joints() + 0.15 * self.persons[curr_person['id']]['pose_3d'].get_joints()

                        smoothed_confidence = 0.85 * curr_person['confidence'] + 0.15 * self.persons[curr_person['id']][
                            'confidence']
    ...
    def jsonify(self):
        ...
        for i in range(len(persons)):
            ...
            annot = {'id': persons[i]['id'], 'pose_2d': {}, 'pose_3d': {},
