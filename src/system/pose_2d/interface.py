...
class Pose2DInterface:
    ...
    def __init__(self, session, protograph, post_processing, input_size, subject_padding, input_node_name,
                 output_node_name):
    ...
    def predict(self, img, subject_bboxes, prev_poses=[]):
        ...
        for subject_id in range(len(subject_bboxes)):
            ...
            for i in range(len(subject_bboxes)):
                ...
                curr_bbox = curr_bbox.scale(1.0 / subject_bbox_padded.get_width(),
                                            1.0 / subject_bbox_padded.get_height())
